...
namespace NextHireApp.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("NextHireApp") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "NextHireApp", DisplayName = "NextHireApp API", Resources = { "NextHireApp" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        {
            var swaggerRootUrl = configurationSection["NextHireApp_Swagger:RootUrl"]?.TrimEnd('/');
